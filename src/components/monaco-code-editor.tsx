...
const MonacoEditor = dynamic(() => import("@monaco-editor/react"), {
  ssr: false,
  loading: () => (
    <div className="flex h-full min-h-105 items-center justify-center bg-[#111722] text-sm text-slate-400">
      Loading editor...
    </div>
  ),
});
...
export function MonacoCodeEditor({
  ...
  return (
    <div className="h-full overflow-hidden border border-white/8 bg-[#10161f]">
      <MonacoEditor
