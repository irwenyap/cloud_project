...
export function CloudJobRunnerDashboard() {
  ...
  return (
    <main className="relative h-screen overflow-hidden bg-[#090c12] text-slate-100">
      ...
      <div className="relative flex h-full min-h-0 flex-col overflow-hidden p-3 sm:p-4 lg:p-5">
        <div className="shrink-0">
          <DashboardTopBar />
        </div>

        <div className="mt-0 grid min-h-0 flex-1 items-stretch gap-0 overflow-hidden border-x border-b border-white/8 bg-[linear-gradient(180deg,rgba(6,9,14,0.82),rgba(8,11,17,0.9))] lg:grid-cols-[280px_minmax(0,1fr)] xl:grid-cols-[280px_minmax(0,1fr)_360px]">
          <DashboardSidebar
